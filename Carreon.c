...
frac add(frac frac1, frac frac2){
    ...
    if(frac1.denom == frac2.denom){
    	temp.num = frac1.num + frac2.num;
    	temp.denom  = frac1.denom ;
	}else{
		temp.num = (frac1.num * frac2.denom) + (frac2.num * frac1.denom);
        temp.denom  = frac1.denom * frac2.denom;
	}
    
    return temp;
}

frac sub(frac frac1, frac frac2){
    frac temp;
...
frac mult(frac frac1, frac frac2){
	frac temp;
...
frac div(frac frac1, frac frac2){
	frac temp;
    
    temp.num = frac1.num * frac2.denom;
    temp.denom  = frac1.denom * frac2.num;
...
int main(void)
{
	...
	printf("sum of %d/%d and %d/%d is: \n", num1.num , num1.denom , num2.num , num2.denom);
    printf("= %d/%d\n", sum.num , sum.denom);
    printf("sum of %d/%d and %d/%d is: \n", num3.num , num3.denom , num4.num , num4.denom);
    printf("= %d/%d\n", sum2.num , sum2.denom);
    printf("difference of %d/%d and %d/%d is: \n", num1.num , num1.denom , num2.num , num2.denom);
    printf("= %d/%d\n", dif.num , dif.denom);
    printf("product of %d/%d and %d/%d is: \n", num1.num , num1.denom , num2.num , num2.denom);
    printf("= %d/%d\n", prod.num , prod.denom);
    printf("quotient of %d/%d and %d/%d is: \n", num1.num , num1.denom , num2.num , num2.denom);
    printf("= %d/%d\n", quo.num , quo.denom);
    ...
    if(num > denom){ 
    	...
    	printf("Mixed Fraction: %d %d/%d", num,remainder,denom);
	}else{
		printf("Dili mana improper fraction");
	}
...
// // if mag pr diay mo throughout the week, pls lng ping sa discord or sa messenger
// Name *getNamesPassed(Student list[], int n);
// StudentList getStudentPassed(StudentList list); //
// // sir sa insertsorted tibook student record i insert sir?
// int main() {
